...
type TBESENFunctionLiteralContainer=class;
     ...
     TBESENASTNode=class(TBESENCollectorObject)
      public
       ...
       Target:TBESENTarget;
       CodeLocation:TBESENLocation; // this is ok, original.
     ...
     function BesenASTNodeString(const BESENASTNodeType: TBESENASTNodeType): TBESENString;
...
begin
	...
	case BESENASTNodeType of
		bntNONE: exit('bntNONE');
		bntEXPRESSION: exit('bntEXPRESSION');
		bntLITERAL: exit('bntLITERAL');
		bntIDENTIFIER: exit('bntIDENTIFIER');
		bntVARIABLEDECLARATION: exit('bntVARIABLEDECLARATION');
		bntVARIABLEEXPRESSION: exit('bntVARIABLEEXPRESSION');
		bntFUNCTIONBODY: exit('bntFUNCTIONBODY');
		bntFUNCTIONLITERAL: exit('bntFUNCTIONLITERAL');
		bntSTATEMENT: exit('bntSTATEMENT');
		bntVARIABLESTATEMENT: exit('bntVARIABLESTATEMENT');
		bntFUNCTIONDECLARATION: exit('bntFUNCTIONDECLARATION');
		bntEXPRESSIONSTATEMENT: exit('bntEXPRESSIONSTATEMENT');
		bntEMPTYSTATEMENT: exit('bntEMPTYSTATEMENT');
		bntBLOCKSTATEMENT: exit('bntBLOCKSTATEMENT');
		bntDEBUGGERSTATEMENT: exit('bntDEBUGGERSTATEMENT');
		bntBREAKSTATEMENT: exit('bntBREAKSTATEMENT');
		bntCONTINUESTATEMENT: exit('bntCONTINUESTATEMENT');
		bntDOSTATEMENT: exit('bntDOSTATEMENT');
		bntWHILESTATEMENT: exit('bntWHILESTATEMENT');
		bntWITHSTATEMENT: exit('bntWITHSTATEMENT');
		bntFORSTATEMENT: exit('bntFORSTATEMENT');
		bntFORINSTATEMENT: exit('bntFORINSTATEMENT');
		bntIFSTATEMENT: exit('bntIFSTATEMENT');
		bntLABELLEDSTATEMENT: exit('bntLABELLEDSTATEMENT');
		bntCASESTATEMENT: exit('bntCASESTATEMENT');
		bntSWITCHSTATEMENT: exit('bntSWITCHSTATEMENT');
		bntTHROWSTATEMENT: exit('bntTHROWSTATEMENT');
		bntTRYSTATEMENT: exit('bntTRYSTATEMENT');
		bntARRAYLITERAL: exit('bntARRAYLITERAL');
		bntBINARYEXPRESSION: exit('bntBINARYEXPRESSION');
		bntASSIGNMENTEXPRESSION: exit('bntASSIGNMENTEXPRESSION');
		bntASSIGNMENTOPERATOREXPRESSION: exit('bntASSIGNMENTOPERATOREXPRESSION');
		bntASSIGNMENTMULTIPLYEXPRESSION: exit('bntASSIGNMENTMULTIPLYEXPRESSION');
		bntASSIGNMENTDIVIDEEXPRESSION: exit('bntASSIGNMENTDIVIDEEXPRESSION');
		bntASSIGNMENTMODULOEXPRESSION: exit('bntASSIGNMENTMODULOEXPRESSION');
		bntASSIGNMENTPLUSEXPRESSION: exit('bntASSIGNMENTPLUSEXPRESSION');
		bntASSIGNMENTMINUSEXPRESSION: exit('bntASSIGNMENTMINUSEXPRESSION');
		bntASSIGNMENTSHIFTLEFTEXPRESSION: exit('bntASSIGNMENTSHIFTLEFTEXPRESSION');
		bntASSIGNMENTSHIFTRIGHTEXPRESSION: exit('bntASSIGNMENTSHIFTRIGHTEXPRESSION');
		bntASSIGNMENTSHIFTRIGHTUNSIGNEDEXPRESSION: exit('bntASSIGNMENTSHIFTRIGHTUNSIGNEDEXPRESSION');
		bntASSIGNMENTBITWISEANDEXPRESSION: exit('bntASSIGNMENTBITWISEANDEXPRESSION');
		bntASSIGNMENTBITWISEXOREXPRESSION: exit('bntASSIGNMENTBITWISEXOREXPRESSION');
		bntASSIGNMENTBITWISEOREXPRESSION: exit('bntASSIGNMENTBITWISEOREXPRESSION');
		bntBINARYOPERATOREXPRESSION: exit('bntBINARYOPERATOREXPRESSION');
		bntBINARYCOMMAEXPRESSION: exit('bntBINARYCOMMAEXPRESSION');
		bntBINARYDIVIDEEXPRESSION: exit('bntBINARYDIVIDEEXPRESSION');
		bntBINARYMODULOEXPRESSION: exit('bntBINARYMODULOEXPRESSION');
		bntBINARYMULTIPLYEXPRESSION: exit('bntBINARYMULTIPLYEXPRESSION');
		bntBINARYPLUSEXPRESSION: exit('bntBINARYPLUSEXPRESSION');
		bntBINARYMINUSEXPRESSION: exit('bntBINARYMINUSEXPRESSION');
		bntBINARYSHIFTLEFTEXPRESSION: exit('bntBINARYSHIFTLEFTEXPRESSION');
		bntBINARYSHIFTRIGHTEXPRESSION: exit('bntBINARYSHIFTRIGHTEXPRESSION');
		bntBINARYSHIFTRIGHTUNSIGNEDEXPRESSION: exit('bntBINARYSHIFTRIGHTUNSIGNEDEXPRESSION');
		bntBINARYGREATERTHANEXPRESSION: exit('bntBINARYSHIFTRIGHTUNSIGNEDEXPRESSION');
		bntBINARYGREATERTHANOREQUALEXPRESSION: exit('bntBINARYGREATERTHANOREQUALEXPRESSION');
		bntBINARYLESSTHANEXPRESSION: exit('bntBINARYLESSTHANEXPRESSION');
		bntBINARYLESSTHANOREQUALEXPRESSION: exit('bntBINARYLESSTHANOREQUALEXPRESSION');
		bntBINARYINSTANCEOFEXPRESSION: exit('bntBINARYINSTANCEOFEXPRESSION');
		bntBINARYINEXPRESSION: exit('bntBINARYINEXPRESSION');
		bntBINARYEQUALEQUALEXPRESSION: exit('bntBINARYEQUALEQUALEXPRESSION');
		bntBINARYEQUALEQUALEQUALEXPRESSION: exit('bntBINARYEQUALEQUALEQUALEXPRESSION');
		bntBINARYNOTEQUALEXPRESSION: exit('bntBINARYNOTEQUALEXPRESSION');
		bntBINARYNOTEQUALEQUALEXPRESSION: exit('bntBINARYNOTEQUALEQUALEXPRESSION');
		bntBINARYBITWISEANDEXPRESSION: exit('bntBINARYBITWISEANDEXPRESSION');
		bntBINARYBITWISEXOREXPRESSION: exit('bntBINARYBITWISEXOREXPRESSION');
		bntBINARYBITWISEOREXPRESSION: exit('bntBINARYBITWISEOREXPRESSION');
		bntBOOLEANLITERAL: exit('bntBOOLEANLITERAL');
		bntCALLEXPRESSION: exit('bntCALLEXPRESSION');
		bntNEWEXPRESSION: exit('bntNEWEXPRESSION');
		bntCONDITIONALEXPRESSION: exit('bntCONDITIONALEXPRESSION');
		bntUNARYEXPRESSION: exit('bntUNARYEXPRESSION');
		bntUNARYOPERATOREXPRESSION: exit('bntUNARYOPERATOREXPRESSION');
		bntUNARYPLUSEXPRESSION: exit('bntUNARYPLUSEXPRESSION');
		bntUNARYMINUSEXPRESSION: exit('bntUNARYMINUSEXPRESSION');
		bntUNARYBITWISENOTEXPRESSION: exit('bntUNARYBITWISENOTEXPRESSION');
		bntUNARYLOGICALNOTEXPRESSION: exit('bntUNARYLOGICALNOTEXPRESSION');
		bntUNARYVOIDEXPRESSION: exit('bntUNARYVOIDEXPRESSION');
		bntUNARYTYPEOFEXPRESSION: exit('bntUNARYTYPEOFEXPRESSION');
		bntPROPERTYEXPRESSION: exit('bntPROPERTYEXPRESSION');
		bntLOGICALANDEXPRESSION: exit('bntLOGICALANDEXPRESSION');
		bntLOGICALOREXPRESSION: exit('bntLOGICALOREXPRESSION');
		bntDELETEEXPRESSION: exit('bntDELETEEXPRESSION');
		bntPOSTFIXINCEXPRESSION: exit('bntPOSTFIXINCEXPRESSION');
		bntPOSTFIXDECEXPRESSION: exit('bntPOSTFIXDECEXPRESSION');
		bntPREFIXINCEXPRESSION: exit('bntPREFIXINCEXPRESSION');
		bntPREFIXDECEXPRESSION: exit('bntPREFIXDECEXPRESSION');
		bntNULLLITERAL: exit('bntNULLLITERAL');
		bntNUMBERLITERAL: exit('bntNUMBERLITERAL');
		bntREGEXPLITERAL: exit('bntREGEXPLITERAL');
		bntSTRINGLITERAL: exit('bntSTRINGLITERAL');
		bntTHISLITERAL: exit('bntTHISLITERAL');
		bntOBJECTLITERALPROPERTY: exit('bntOBJECTLITERALPROPERTY');
		bntOBJECTLITERAL: exit('bntOBJECTLITERAL');
		bntRETURNSTATEMENT: exit('bntRETURNSTATEMENT');
		bntPROGRAM: exit('bntPROGRAM');
		bntFUNCTIONEXPRESSION: exit('bntFUNCTIONEXPRESSION');
	end;

exit('unknown ast node.');
...
begin
 ...
 CodeLocation.SetInfo(-1, -1, TBESEN(Instance).CurrentFile); // was FilenameSet
{
 CodeLocation.LineNumber:=		-1;
 CodeLocation.ColumnNumber:=	-1;
 CodeLocation.Filename:=		TBESEN(Instance).FilenameSet;
}
